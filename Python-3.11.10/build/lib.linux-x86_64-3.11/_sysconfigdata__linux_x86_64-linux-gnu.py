...
build_time_vars = {'ABIFLAGS': '',
 ...
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/workspaces/ITransition-Task4-Web-application-with-user-registration-and-authentication./Python-3.11.10/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/workspaces/ITransition-Task4-Web-application-with-user-registration-and-authentication./Python-3.11.10/lcov-report',
 ...
 'abs_builddir': '/workspaces/ITransition-Task4-Web-application-with-user-registration-and-authentication./Python-3.11.10',
 'abs_srcdir': '/workspaces/ITransition-Task4-Web-application-with-user-registration-and-authentication./Python-3.11.10',
